...
angular.module('newApp')
    .controller('my_profileUploadCtrl', ['$scope', 'FileUploader', 'settingsFactory', function($scope, FileUploader, settingsFactory) {
        ...
        img_uploader.onCompleteItem = function(fileItem, response, status, headers) {
            ...
            $scope.my_profile_data.avatar = response.file_name;
