...
angular.module('newApp').factory('statsFactory', ['$http', 'settingsFactory', function ($http, settingsFactory) {
    ...
    stats.ExamChart = function (dataExamPass, dataExamNotPass) {
        var ExamChartData = [
    ...
    stats.CompareChart = function (dataOver, dataUnder) {
    ...
    stats.PrePostChart = function (dataPreTest, dataPostTest) {
    ...
    stats.notPassChart = function (dataQuizProcess, dataNotLearning, dataLearningNotPass, dataLearningPassNotExam, dataExamNotPass) {
        if(dataQuizProcess){
    ...
    stats.passChart = function (dataNotCertificate, dataCertificate) {
        var passChartData = [
    ...
    stats.learningChart = function (dataQuizProcess, dataNotLearning, dataLearningNotPass, dataLearningPassNotExam, dataExamNotPass, dataExamPass, dataLearningPass) {
        if (dataQuizProcess) {
    ...
    stats.mobileChart = function (dataiOS, dataAndroid) {
        var mobileChartData = [
    ...
    stats.desktopChart = function (dataWindows, dataMac, dataLinux) {
    ...
    stats.LogEventChart = function (Labels, Data) {
    ...
    stats.stockCharts = function (data) {
        ...
        // Create the chart
        $('#stats-chart').highcharts('StockChart', {
            chart: {
                height: 286,
                borderColor: '#DE0E13'
            },
    ...
    stats.getStatsEnroll = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/enroll' + '?' + queryString);
    };

    stats.getStatsLogs = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/log' + '?' + queryString);
    };

    stats.getStatsDevice = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/device' + '?' + queryString);
    };

    stats.getStatsAll = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/all' + '?' + queryString);
    };

    stats.getStatsCities = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/city' + '?' + queryString);
    };

    stats.getStatsStates = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/state' + '?' + queryString);
    };

    stats.getStatsCountries = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/country' + '?' + queryString);
    };

    stats.getStatsInfo = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/info' + '?' + queryString);
    };

    stats.getStats = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/stats' + '?' + queryString);
    };

    stats.getStatsLearning = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/learning' + '?' + queryString);
    };

    stats.getStatsCourses = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/courses' + '?' + queryString);
    };

    stats.getStatsQuiz = function (queryString) {
        return $http.get(settingsFactory.get('stats') + '/quiz' + '?' + queryString);
    };
    ...
    stats.getCourse = function(theCourses) {
        return $http.get(settingsFactory.get('stats') + '/' + theCourses.id + '/course');
    };
