...
angular.module('newApp')
    .controller('imagesCoursesSignatureUploadCtrl', ['$scope', 'FileUploader', 'functionsFactory', 'settingsFactory', function($scope, FileUploader, functionsFactory, settingsFactory) {

        var img_uploader = $scope.img_uploader = new FileUploader({
            url: settingsFactory.getUpload("upload_images_signature")
        });
