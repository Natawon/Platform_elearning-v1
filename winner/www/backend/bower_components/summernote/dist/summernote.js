...
(function (factory) {
  ...
  var EventHandler = function () {
    ...
    this.attachCustomEvent = function (layoutInfo, options) {
      ...
      // [workaround] IE doesn't have input courses for contentEditable
   ...
   * @param {Object} [plugin.courses] add event in $.summernote.pluginEvents
  ...
  $.fn.extend({
     ...
     *  - create editor layout and attach Mouse and keyboard courses.
     * 
     * ```
    ...
    summernote: function () {
      ...
      this.each(function (idx, holder) {
        ...
        // if layout isn't created yet, createLayout and attach courses
