(function (factory) {
  ...
  $.summernote.addPlugin({
     ...
     * @property {Function} courses.hello  run function when button that has a 'hello' event name  fires click
     * @property {Function} courses.helloDropdown run function when button that has a 'helloDropdown' event name  fires click
     * @property {Function} courses.helloImage run function when button that has a 'helloImage' event name  fires click
     */
    events: { // courses
