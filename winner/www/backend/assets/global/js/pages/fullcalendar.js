function runCalendar() {
    ...
    $('#external-courses div.external-event').each(function () {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        eventLimit: true, // allow "more" link when too many courses
        drop: function (date) { 
            // retrieve the dropped element's stored Event Object
            var originalEventObject = $(this).data('eventObject');
            var $categoryClass = $(this).attr('data-class');
            // we need to copy it, so that multiple courses don't have a reference to the same object
