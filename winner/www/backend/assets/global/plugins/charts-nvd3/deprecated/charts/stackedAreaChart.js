 ...
 * should be equal to the gap from Monday to Tuesday. (and of courses, holidays can be
  ...
  chart.build = function() {
    ...
    nv.addGraph({
      ...
      callback: function(graph) {
        ...
        window.onresize =
        function() {
          // now that width and height are functions, should be automatic..of courses you can always override them
