  ...
  d3.svg.brush = function() {
    function brush(g) {
      g.each(function() {
        ...
        g.style("pointer-courses", "all").on("mousedown.brush", brushstart).on("touchstart.brush", brushstart);
    ...
    function brushstart() {
      ...
      function brushend() {
        brushmove();
        g.style("pointer-courses", "all").selectAll(".resize").style("display", brush.empty() ? "none" : null);
      ...
      g.style("pointer-courses", "none").selectAll(".resize").style("display", null);
