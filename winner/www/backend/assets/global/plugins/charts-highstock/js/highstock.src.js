...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		 ...
		 * @param {String} eventType The event type. Leave blank to remove all courses.
		 * @param {Function} handler The function to remove
		 */
		removeEvent: function (el, eventType, handler) {
			// workaround for jQuery issue with unbinding custom courses:
		...
		fireEvent: function (el, type, eventArguments, defaultFunction) {
			...
			// order to prevent JS errors when cancelling courses on non-DOM
			// objects. #615.
			/*jslint unparam: true*/
...
SVGRenderer.prototype = {
	...
	button: function (text, x, y, callback, normalState, hoverState, pressedState, disabledState, shape) {
		...
		// Add the courses. IE9 and IE10 need mouseover and mouseout to funciton (#667).
...
Pointer.prototype = {
	...
	runPointActions: function (e) {
		...
		// Separate tooltip and general mouse courses
	...
	onContainerMouseMove: function (e) {
		...
		// Show the tooltip and run mouse over courses (#977)
	...
	onContainerClick: function (e) {
		...
		if (!chart.cancelClick) {
			...
			// On tracker click, fire the series and point courses. #783, #1583
	...
	/**
	 * Set the JS DOM courses on the container and document. This method should contain
	...
	/**
	 * Destroys the Pointer object and disconnects DOM courses.
	 */
	destroy: function () {
		var prop;
...
extend(Highcharts.Pointer.prototype, {
	...
	/**
	 * Handle touch courses with two touches
	 */
	pinch: function (e) {
	...
	onContainerTouchStart: function (e) {
		...
		if (e.touches.length === 1) {
			...
			if (chart.isInsidePlot(e.chartX - chart.plotLeft, e.chartY - chart.plotTop)) {
				...
				// Run mouse courses and display tooltip etc
				this.runPointActions(e);
...
if (win.PointerEvent || win.MSPointerEvent) {
	...
	extend(Pointer.prototype, {
		...
		/**
		 * Add or remove the MS Pointer specific courses
		 */
	...
	// Add IE specific touch courses to chart
...
Chart.prototype = {
	...
	getContainer: function () {
		...
		if (useCanVG) {
			...
			// to get the tracker for translating mouse courses
...
Series.prototype = {
	...
	invertGroups: function () {
		...
		// On subsequent render and redraw, just do setInvert without setting up courses again
...
var TrackerMixin = Highcharts.TrackerMixin = {
	 ...
	 * track mouse courses on the graph or points. For the line type charts
	...
	drawTrackerGraph: function () {
		...
		if (tracker) {
			...
			// by the marker group. So the marker group also needs to capture courses.
...
/* 
 * Extend Legend for item courses
 */ 
extend(Legend.prototype, {

	setItemEvents: function (item, legendItem, useHTML, itemStyle, itemHiddenStyle) {
	var legend = this;
	// Set the courses on the item group, or in case of useHTML, the item itself (#1249)
...
extend(Point.prototype, {
	...
	/**
	 * Import courses from the series' and point's options. Only do it on
...
Scroller.prototype = {
	...
	/**
	 * Set up the mouse and touch courses for the navigator and scrollbar
	 */
	addEvents: function () {
	...
	destroy: function () {
		...
		// Disconnect courses added in addEvents
...
RangeSelector.prototype = {
	...
	drawInput: function (name) {
		...
		// Create an SVG label that shows updated date ranges and and records click courses that
