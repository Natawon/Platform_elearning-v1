...
(function ($) {
	...
	function iPadTouchStart(event) {
		...
		// Mouse over first - I have live courses attached on mouse over
	...
	function iPadTouchHandler(event) {
		...
		case "touchstart":
			...
			iPadTouchStart(event); /*We need to trigger two courses here to support one touch drag and drop*/
