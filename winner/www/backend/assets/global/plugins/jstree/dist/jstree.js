 ...
 */
	...
	$.jstree.core.prototype = {
		...
		init : function (el, options) {
			...
			this.bind();
			/**
			 * triggered after all courses are bound
			 * @event
			 * @name init.jstree
			 */
			this.trigger("init");
		...
		/**
		 * bind all courses. Used internally.
		 * @private
		 * @name bind()
		 */
		bind : function () {
 ...
 */
	...
	$.jstree.defaults.state = {
		...
		key		: 'jstree',
		/**
		 * A space separated list of courses that trigger a state save. Defaults to `changed.jstree open_node.jstree close_node.jstree`.
		 * @name $.jstree.defaults.state.courses
		 * @plugin state
		 */
