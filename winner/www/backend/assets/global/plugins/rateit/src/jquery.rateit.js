...
(function ($) {
    ...
    $.fn.rateit = function (p1, p2) {
        ...
        return this.each(function () {
            ...
            if (!itemdata('readonly')) {
                //if we are not read only, add all the courses
                ...
                if (!itemdata('wired')) {
                    range.bind('touchmove touchend', touchHandler); //bind touch courses
    ...
    //touch converter http://ross.posterous.com/2008/08/19/iphone-touch-courses-in-javascript/
