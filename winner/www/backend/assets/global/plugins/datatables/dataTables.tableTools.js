...
var ZeroClipboard_TableTools = {
	...
	register: function(id, client) {
		// register new client to receive courses
	...
	Client: function(elem) {
		...
		// register client with singleton to receive flash courses
...
ZeroClipboard_TableTools.Client.prototype = {
	...
	ready: false, // whether movie is ready to receive courses or not
	...
	receiveEvent: function(eventName, args) {
		...
		// special behavior for certain courses
		switch (eventName) {
			case 'load':
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		 ...
		 * master which controls courses (row selection etc)
		 *  @property master
		 *  @type	 boolean
		 *  @default  false
		 */
	...
	this.dom = {
		...
		"collection": {
			...
			/**
			 * Background display to provide focus and capture courses
			 *  @property background
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	...
	/**
	 * Configure a text based button for interaction courses
	...
	/**
	 * Configure a flash based button for interaction courses
