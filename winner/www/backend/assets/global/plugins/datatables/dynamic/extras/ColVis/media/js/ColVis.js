...
ColVis = function( oDTSettings, oInit )
{
	...
	this.dom = {
		...
		/**
		 * Element to position over the activation button to catch mouse courses when using mouseover
		 *  @property catcher
		 *  @type     Node
		 *  @default  null
		 */
...
ColVis.prototype = {
	...
	/**
	 * An element to be placed on top of the activate button to catch courses
	...
	/**
	 * Create the element used to shade the background, and capture hide courses (it is shown and
	 * hidden as needed)
	...
	"_fnDomBackground": function ()
	{
		 ...
		 * bubbling courses. Use the catcher element to avoid messing around with bubbling
		 */
