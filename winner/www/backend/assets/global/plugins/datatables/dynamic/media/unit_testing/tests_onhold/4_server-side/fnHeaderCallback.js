...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			$('#example').dataTable( {
				"bServerSide": true,
		"sAjaxSource": "examples/de/scripts/server_processing.php",
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			$('#example').dataTable( {
				"bServerSide": true,
		"sAjaxSource": "examples/server_sis/server_processing.php",
				"fnHeaderCallback": function ( nHead, aasData, iStart, iEnd, aiDisplay ) {
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			$('#example').dataTable( {
				"bServerSide": true,
		"sAjaxSource": "examples/server_side/scriptprocessing.php",
				"fnHeaderCallback": function ( nHead, aasData, iStart, iEnd, aiDisplay ) {
					if ( iStart != 0 )
					{
						mPass = false;
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			$('#example').dataTable( {
				"bServerSide": true,
		"sAjaxSource": "examples/server_side/scripts/server_g.php",
				"fnHeaderCallback": function ( nHead, aasData, iStart, iEnd, aiDisplay ) {
					if ( iStart == 0 )
					{
						mPass = true;
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			$('#example').dataTable( {
				"bServerSide": true,
		"sAjaxSource": "examples/server_side/scripts/server_processin			"fnHeaderCallback": function ( nHead, aasData, iStart, iEnd, aiDisplay ) {
					if ( iEnd == 10 )
					{
						mPass = true;
					}
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			$('#example').dataTable( {
				"bServerSide": true,
		"sAjaxSource": "examples/server_side/scripts/server_processing.php",
	derCallback": function ( nHead, aasData, iStart, iEnd, aiDisplay ) {
