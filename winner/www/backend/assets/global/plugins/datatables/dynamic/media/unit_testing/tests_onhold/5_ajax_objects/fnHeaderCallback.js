...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			bInit = false;
			$('#example').dataTable( {
				"sAjaxSource": "ajax/sources/objects.txt",
				"aoColumnDefs": [
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			bInit = false;
			$('#example').dataTable( {
				"sAjaxSource": "examples/ces/objects.txt",
				"aoColumnDefs": [
					{ "mData": "engine", "aTargets": [0] },
					{ "mData": "browser", "aTargets": [1] },
					{ "mData": "platform", "aTargets": [2] },
	...
	oTest.fnWaitTest( 
		...
		function () {
			oSession.fnRestore();
			$('#example').dataTable( {
				"sAjaxSource": "examples/ajax/sourts.txt",
				"aoColumnDefs": [
					{ "mData": "engine", "aTargets": [0] },
					{ "mData": "browser", "aTargets": [1] },
					{ "mData": "platform", "aTargets": [2] },
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			mPass = true;
			$('#example').dataTable( {
				"sAjaxSource": "examples/ajax/sources/objec				"aoColumnDefs": [
					{ "mData": "engine", "aTargets": [0] },
					{ "mData": "browser", "aTargets": [1] },
					{ "mData": "platform", "aTargets": [2] },
					{ "mData": "version", "aTargets": [3] },
...
lumnDefs": [
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			$('#example').dataTable( {
				"sAjaxSource": "examples/ajax/sources/objects.txt",
				"aoColumnDefs"{ "mData": "engine", "aTargets": [0] },
					{ "mData": "browser", "aTargets": [1] },
					{ "mData": "platform", "aTargets": [2] },
					{ "mData": "version", "aTargets": [3] },
					{ "mData": "grade", "aTargets": [4] }
