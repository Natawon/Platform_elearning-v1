...
$(document).ready( function () {
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			bInit = false;
			$('#example').dataTable( {
				"sAjaxSource": "examples/ces/arrays.txt",
	...
	oTest.fnWaitTest( 
		...
		function () {
			oSession.fnRestore();
			$('#example').dataTable( {
				"sAjaxSource": "examples/ajax/sours.txt",
				"fnHeaderCallback": function ( nHead, aasData, iStart, iEnd, aiDisplay ) {
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			mPass = true;
			$('#example').dataTable( {
				"sAjaxSource": "examples/ajax/sources/array			"fnHeaderCallback": function ( nHead, aasData, iStart, iEnd, aiDisplay ) {
					if ( iStart != 0 )
					{
						mPass = false;
					}
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			$('#example').dataTable( {
				"sAjaxSource": "examples/ajax/sources/arrays.txt",
				"fnHeack": function ( nHead, aasData, iStart, iEnd, aiDisplay ) {
					if ( iEnd == 20 )
					{
						mPass = true;
					}
	...
	oTest.fnWaitTest( 
		...
		function () {
			...
			$('#example').dataTable( {
				"sAjaxSource": "examples/ajax/sources/arrays.txt",
				"fnHeaderCallbation ( nHead, aasData, iStart, iEnd, aiDisplay ) {
