...
describe('eventLimit popover', function() {
	...
	describe('when in month view', function() {
		...
		it('works with background courses', function() {
			options.events.push({
				start: '2014-07-29',
		...
		it('works with courses that have invalid end times', function() {
			options.events = [
		...
		// issue 2385
		it('orders courses correctly regardless of ID', function() {
	...
	describe('when dragging courses out', function() {
