...
describe('timezone', function() {
	...
	// NOTE: Only deals with the processing of *received* courses.
	// Verification of a correct AJAX *request* is done in courses-json-feed.js
	...
	it('receives courses correctly when no timezone', function(done) {
	...
	it('receives courses correctly when local timezone', function(done) {
	...
	it('receives courses correctly when UTC timezone', function(done) {
	...
	it('receives courses correctly when custom timezone', function(done) {
