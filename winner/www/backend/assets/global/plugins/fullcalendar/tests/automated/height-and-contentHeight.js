...
[ 'height', 'contentHeight' ].forEach(function(heightProp) { describe(heightProp, function() {
	...
	$.each({
		...
		describe('when in month view', function() {
			...
			describe('as a number, when there are no courses', function() {
			...
			describe('as a number, when there is one tall row of courses', function() {
				beforeEach(function() {
			...
			describe('as a number, when there are many tall rows of courses', function() {
				beforeEach(function() {
			...
			describe('as "auto", when there are many tall rows of courses', function() {
				beforeEach(function() {
					options.events = [].concat(
						repeatClone({ title: 'event0', start: '2014-07-28' }, 9),
						repeatClone({ title: 'event1', start: '2014-08-04' }, 9),
		...
		[ 'basicWeek', 'basicDay' ].forEach(function(viewName) {
			describe('in ' + viewName + ' view', function() {
				...
				describe('as a number, when there are many courses', function() {
					beforeEach(function() {
				...
				describe('as "auto", when there are many courses', function() {
					beforeEach(function() {
						options.events = repeatClone({ title: 'event', start: '2014-08-01' }, 100);
					});
