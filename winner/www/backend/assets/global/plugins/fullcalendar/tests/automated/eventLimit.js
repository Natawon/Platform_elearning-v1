...
describe('eventLimit', function() {
	...
	describe('as a number', function() {
		...
		[ 'month', 'basicWeek', 'agendaWeek' ].forEach(function(viewName) {
			...
			describe('when in ' + viewName + ' view', function() {
				...
				it('doesn\'t display a more link when limit is more than the # of courses', function() {
					options.events = [
				...
				it('doesn\'t display a more link when limit equal to the # of courses', function() {
					options.events = [
						{ title: 'event1', start: '2014-07-29' },
						{ title: 'event2', start: '2014-07-29' },
						{ title: 'event2', start: '2014-07-29' }
				...
				it('displays a more link when limit is less than the # of courses', function() {
					options.events = [
						{ title: 'event1', start: '2014-07-29' },
						{ title: 'event2', start: '2014-07-29' },
						{ title: 'event2', start: '2014-07-29' },
				...
				it('will render a link in a multi-day event\'s second column ' +
					'if it has already been hidden in the first even if he second column hardly has any courses',
				function() {
					options.events = [
	...
	describe('when auto', function() {
		...
		describe('in month view', function() {
			...
			it('renders the heights of all the rows the same, regardless of # of courses', function() {
				$('#cal').fullCalendar(options);
			...
			it('renders a more link when there are obviously too many courses', function() {
				$('#cal').width(800);
				$('#cal').fullCalendar(options);
