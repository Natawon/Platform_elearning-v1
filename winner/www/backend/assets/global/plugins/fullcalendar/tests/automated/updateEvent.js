...
describe('updateEvent', function() {
	...
	describe('when moving an all-day event\'s start and end', function() {
		it('should move the start and end of related courses', function() {
			options.events = [
				{ id: '1', start: '2014-05-01', end: '2014-05-03', allDay: true },
				{ id: '1', start: '2014-05-10', end: '2014-05-13', allDay: true }
			];
	...
	describe('when changing an event from all-day to timed', function() {
		describe('when the event\'s dates remain all-day', function() {
			it('should make the event and related courses allDay=false and 00:00', function() {
				options.events = [
					{ id: '1', start: '2014-05-01', end: '2014-05-03', allDay: true },
					{ id: '1', start: '2014-05-10', end: '2014-05-13', allDay: true }
				];
	...
	it('should copy color-related properties to related courses', function() {
		options.events = [
			{ id: '1', start: '2014-05-01', end: '2014-05-03', allDay: true },
			{ id: '1', start: '2014-05-10', end: '2014-05-13', allDay: true }
		];
	...
	it('should non-standard properties to related courses', function() {
		options.events = [
			{ id: '1', start: '2014-05-01', end: '2014-05-03', allDay: true },
			{ id: '1', start: '2014-05-10', end: '2014-05-13', allDay: true }
		];
	...
	function shouldBeAmbiguouslyZoned() {
		it('should make the courses ambiguously zoned', function() {
	...
	function shouldBeLocal() {
		it('should make the courses local', function() {
	...
	function shouldBeUTC() {
		it('should make the courses UTC', function() {
			expect(event.start.hasZone()).toEqual(true);
