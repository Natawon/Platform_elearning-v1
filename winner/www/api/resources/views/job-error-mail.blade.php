...
<p>ระบบตรวจสอบพบว่ามีการแปลงไฟล์วีดีโอล้มเหลว โดยมีรายละเอียดดังนี้</p>
...
<p>ปัญหาที่พบ : <strong style="color: red;">{{ $dataJob->sc_job_error_code }}: {{ $dataJob->sc_job_error_message }}</strong></p>
<p>วันและเวลาที่เริ่มแปลงไฟล์ : <strong>{{ $dataJob->sc_job_start_time }}</strong></p>
<p>วันและเวลาที่พบปัญหา : <strong>{{ $dataJob->modify_datetime }}</strong></p>
