...
@endif
<p>คุณได้เปลี่ยนรหัสผ่าน <strong>{{ $dataGroup->subject }}</strong></p>
<p>รหัสผ่าน (password) สำหรับการเข้าใช้งาน elearning.set.or.th/{{ $dataGroup->key }} คือ <strong>{{ $change_password }}</strong></p>
