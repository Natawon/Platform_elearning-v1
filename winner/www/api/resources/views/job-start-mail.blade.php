...
<p>ระบบได้เริ่มแปลงไฟล์วีดีโอเรียบร้อย โดยมีรายละเอียดดังนี้</p>
...
<p>วันและเวลาที่เริ่มแปลงไฟล์ : <strong>{{ $startTranscodeDateTime }}</strong></p>
<p>วันและเวลาที่คาดว่าจะแปลงไฟล์สำเร็จ : <strong>{{ $estimatedTranscodeDateTime }}</strong></p>
