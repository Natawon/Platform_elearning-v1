...
<div class="row">
	<div class="col-md-8 col-md-offset-2 col-sm-6 col-sm-offset-3">
		<div id="login">
                ...
                <div class="col-md-12">
                    <div class="text-center">
                        ...
                        <div class="btn-group" role="group" aria-label="...">
                            <button type="button" class="btn btn-set btn-square f-18 btn-sm btnFormThai active">สำหรับคนไทย</button>
                            <button type="button" class="btn btn-set btn-square f-18 btn-sm btnFormForeign">For Foreigners</button>
                        </div>
                    </div>
            ...
            <form id="account-form" method="post" role="form" data-toggle="validator" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="" name="birth_date" class="form-control birth_date required"  placeholder="วันเกิด">
                       </div>
                       <div class="form-group">
                            <label>สัญชาติ <span class="text-danger">*</span></label>
                            <input type="text" id="nationality" name="nationality" class="form-control required"  placeholder="สัญชาติ" value="ไทย">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="styled-select" style="margin-bottom: 0px;">
                                <select class="form-control sub_groups_id" name="sub_groups_id" id="">
                                    <!-- <option value="" selected>เลือกสถาบัน / หน่วยงาน</option> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="styled-select" style="margin-bottom: 0px;">
                                <select class="form-control level_groups_id" name="level_groups_id" id="">
                                    ...
                                    <!-- <option value="" selected>เลือกคณะ / ฝ่ายงาน</option> -->
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label><?=$groups['meaning_of_level_groups_id']?> <span class="text-danger">*</span></label>
                            <input type="text" id="" name="level_groups_id" class="form-control level_groups_id required"  placeholder="<?=$groups['meaning_of_level_groups_id']?>">
                        </div>
                        <?php */ ?>
                       ...
                       <div class="vspace-27 hidden-xxs hidden-xs hidden-sm hide-for-name-title"></div>
                        ...
                        <div class="form-group custom-for-name-title">
                            <label><?=$groups['meaning_of_occupation_id']?> <span class="text-danger">*</span></label>
                            <input type="text" id="occupation_id" name="occupation_id" class="form-control required"  placeholder="<?=$groups['meaning_of_occupation_id']?>">
                            <!-- <input type="text" id="occupation_id" name="occupation_id" class="form-control required"  placeholder="รหัสนักศึกษา / รหัสพนักงาน"> -->
                        </div>
                       ...
                       if ($groups['id'] == 3) {
                            ...
                            <?php /* ?>
                            <div class="form-group">
                                <label>ประเภทใบอนุญาต <span class="text-danger">*</span></label>
                                <?php
                                foreach ($licenseTypes['data'] as $licenseType) {
                                    ?>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="license_types_id" value="<?php echo $licenseType['id']; ?>">
                                            <?php echo $licenseType['title']; ?>
                                        </label>
                                    </div>
                                    <?php
                                }
                            ...
                            <div class="form-group">
                                <label>เลขที่ใบอนุญาต (IC License) </label>
                                <input type="text" id="license_id" name="license_id" class="form-control required"  placeholder="เลขที่ใบอนุญาต (IC License)">
                            </div>

                            <div class="form-group">
                                <label>ตำแหน่งงาน <span class="text-danger">*</span></label>
                                <input type="text" id="position_id" name="position_id" class="form-control required"  placeholder="ตำแหน่งงาน">
                            </div>
                            <?php
                       }
                       ?>
            ...
            <form id="account-form-foreign" method="post" role="form" data-toggle="validator" enctype="multipart/form-data">
                    <input type="hidden" id="groups_id" name="groups_id" value="<?=$groups['id']?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="">Password <span class="text-danger">*</span> <i class="fa fa-question-circle icon-popover hint-password" rel="popover"></i></label>
                        ...
                        <div class="form-group">
                            <label class="">Name Title <span class="text-danger">*</span></label><br>
                            <label class="radio-inline">
                                <input class="removeButton" data-remove="disabled" type="radio" name="name_title_en" id="name_title_1" value="Mr." checked> <span class="">Mr.</span> &nbsp;
                            </label>
                            <label class="radio-inline">
                                <input class="removeButton" data-remove="disabled" type="radio" name="name_title_en" id="name_title_2" value="Mrs."> <span class="">Mrs.</span> &nbsp;
                            </label>
                            <label class="radio-inline">
                                <input class="removeButton" data-remove="disabled" type="radio" name="name_title_en" id="name_title_3" value="Ms."> <span class="">Ms.</span> &nbsp;
                            </label>
                            <label class="radio-inline">
                                <input class="addButton" data-add="enabled" type="radio" name="name_title_en" id="name_title_4" value="other"> <span class="">Other</span>
                            </label>
                        </div>

                        <div class="form-group hide" id="name_title_other_enTemplate">
                            <input type="text" id="name_title_other_en" name="name_title_other_en" class="form-control m-t-10" placeholder="Name Title" disabled>
                        </div>

                        <?php if ($groups['multi_lang_certificate'] == 1) { ?>
                            <div class="form-group">
                                <label class="">Name Title (TH) <span class="text-danger">*</span></label><br>
                                <label class="radio-inline">
                                    <input class="removeButton" data-remove="disabled" type="radio" name="name_title" id="name_title_1" value="นาย" checked> <span class="">นาย</span> &nbsp;
                                </label>
                                <label class="radio-inline">
                            ...
                            <div class="form-group hide" id="name_title_otherTemplate">
                                <input type="text" id="name_title_other" name="name_title_other" class="form-control m-t-10" placeholder="Name Title (TH)" disabled>
                            </div>
                        <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="first_name_en" name="first_name_en" class="form-control required"  placeholder="First Name">
                        </div>
                        <div class="form-group">
                            <label>Last Name <span class="text-danger">*</span></label>
                            <input type="text" id="last_name_en" name="last_name_en" class="form-control required"  placeholder="Last Name">
                        </div>
                        <?php if ($groups['multi_lang_certificate'] == 1) { ?>
                            <div class="form-group">
                                <label>First Name (TH) <span class="text-danger">*</span></label>
                                <input type="text" id="first_name" name="first_name" class="form-control required"  placeholder="First Name (TH)">
                            </div>
                            <div class="form-group">
                                <label>Last Name (TH) <span class="text-danger">*</span></label>
                                <input type="text" id="last_name" name="last_name" class="form-control required"  placeholder="Last Name (TH)">
                            </div>
                        <?php } ?>
                        <div class="form-group">
                            <label class="">Gender <span class="text-danger">*</span></label><br>
                            <label class="radio-inline">
                                <input type="radio" name="gender" id="gender_1" value="M" checked> <span class="">Male</span> &nbsp;
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="gender" id="gender_2" value="F"> <span class="">Female</span> &nbsp;
                            </label>
                        </div>
                        <div class="form-group">
                            <label>Passport No. <span class="text-danger">*</span></label>
                            <input type="text" id="id_card" name="id_card" maxlength="20" class="form-control required"  placeholder="Passport No.">
                        </div>
                        <div class="form-group">
                            <label>Birth Date <span class="text-danger">*</span></label>
                            <input type="text" id="" name="birth_date" class="form-control birth_date required"  placeholder="Birth Date">
                       </div>
                       <div class="form-group">
                            <label>Nationality <span class="text-danger">*</span></label>
                            <input type="text" id="nationality" name="nationality" class="form-control required"  placeholder="Nationality">
                        </div>
                        <div class="form-group">
                            <label>Mobile Phone <span class="text-danger">*</span></label>
                            <input type="text" id="mobile_number" name="mobile_number" maxlength="10" class="form-control required"  placeholder="Mobile Phone">
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="form-group">
                            <label><?=$groups['meaning_of_sub_groups_id_en']?> <span class="text-danger">*</span></label>
                            <div class="styled-select" style="margin-bottom: 0px;">
                                <select class="form-control sub_groups_id" name="sub_groups_id" id="">
                                    <!-- <option value="" selected>เลือกสถาบัน / หน่วยงาน</option> -->
                                    <option value="" selected>Choose <?=$groups['meaning_of_sub_groups_id_en']?></option>
                                    <?php foreach($groups['sub_groups'] as $sub_groups) {?>
                                    <option value="<?=$sub_groups['id']?>"><?=$sub_groups['title']?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group">
                            <label><?=$groups['meaning_of_level_groups_id_en']?> <span class="text-danger">*</span></label>
                            <div class="styled-select" style="margin-bottom: 0px;">
                                <select class="form-control level_groups_id" name="level_groups_id" id="">
                                    <option value="" selected>Choose <?=$groups['meaning_of_level_groups_id_en']?></option>
                                    <!-- <option value="" selected>เลือกคณะ / ฝ่ายงาน</option> -->
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label><?=$groups['meaning_of_level_groups_id_en']?> <span class="text-danger">*</span></label>
                            <input type="text" id="" name="level_groups_id" class="form-control level_groups_id required"  placeholder="<?=$groups['meaning_of_level_groups_id_en']?>">
                        </div>
                        <?php */ ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="styled-select">
                                <select name="education_level_id" id="education_level_id" class="form-control">
                                    ...
                                    <option value="4">Ph.D. (Doctor of Philosophy)</option>
                                </select>
                            </div>
                       </div>
                       ...
                       <div class="vspace-27 hidden-xxs hidden-xs hidden-sm hide-for-name-title"></div>
                        ...
                        <div class="form-group custom-for-name-title">
                            <label><?=$groups['meaning_of_occupation_id_en']?> <span class="text-danger">*</span></label>
                            <input type="text" id="occupation_id" name="occupation_id" class="form-control required"  placeholder="<?=$groups['meaning_of_occupation_id_en']?>">
                            <!-- <input type="text" id="occupation_id" name="occupation_id" class="form-control required"  placeholder="รหัสนักศึกษา / รหัสพนักงาน"> -->
                        </div>
                       ...
                       if ($groups['id'] == 3) {
                            ...
                            <div class="form-group">
                                <label>IC License </label>
                                <input type="text" id="license_id" name="license_id" class="form-control required"  placeholder="IC License">
                            </div>

                            <div class="form-group">
                                <label>Position <span class="text-danger">*</span></label>
                                <input type="text" id="position_id" name="position_id" class="form-control required"  placeholder="Position">
                            </div>
                            <?php
                       }
                       ?>
                       <!-- //Broker -->
                        ...
                        <div class="form-group">
                            ...
                            <button id="" type="button" class="btn btn-link pull-right reloadCaptcha" style="padding-right: 0;"><i class="fa fa-refresh" aria-hidden="true"></i> <span>Reload captcha code</span></button>
                            <input type="text" id="captcha" name="captcha" class="form-control required"  placeholder="Captcha Code" autocomplete="false">
                        </div>

                    </div>
                    <div id="pass-info" class="clearfix"></div>
                    <button class="button_fullwidth" id="submit-btn">Confirm Registration</button>
            </form>
		</div>
	</div>
</div>
...
$(document).ready(function() {
    ...
    //         //     $formWarpper.find('#name_title_other').prop('disabled', false).removeClass('hide');
    //         // } else {
    //         //     $formWarpper.find('#name_title_other_en').prop('disabled', false).removeClass('hide');
    //         // }
    //         $formWarpper.find('.hide-for-name-title').show();
    //         $formWarpper.find('.hide-for-name-title-other').hide();
    //         $formWarpper.find('.custom-for-name-title').css('margin-top', 'inherit');
    //         $formWarpper.find('.box-captcha').css('min-height', '91px');
    //     } else {
    //         // if ($(this).attr('name') == "name_title") {
    //         //     $formWarpper.find('#name_title_other').prop('disabled', true).addClass('hide');
    //         // } else {
    //         //     $formWarpper.find('#name_title_other_en').prop('disabled', true).addClass('hide');
    //         // }
    //         $formWarpper.find('.hide-for-name-title').hide();
    //         $formWarpper.find('.hide-for-name-title-other').show();
    //         $formWarpper.find('.custom-for-name-title').css('margin-top', '-6px');
    //         $formWarpper.find('.box-captcha').css('min-height', 'inherit');
    //     }
    // });
            ...
            fields: {
                ...
                id_card: {
                    validators: {
                        ...
                        regexp: {
                            regexp: /^[a-z0-9]+$/i,
                            message: 'The id card can consist of alphanumeric characters.'
                        },
                        stringCase: {
                            message: 'The id card must be in uppercase.',
                            case: 'upper'
                        },
                        stringLength: {
                            max: 20,
                            message: 'The id card must be less than 20 characters.'
                        }
                    }
                },
                birth_date: {
                    validators: {
                        ...
                        date: {
                            ...
                            message: 'The birth date is not a valid date (Must be over 5 years old).'
                        }
                    }
                },
                nationality: {
                ...
                occupation_id: {
                    validators: {
                        notEmpty: {
                            message: 'The occupation id is required.'
                        },
                        regexp: {
                            regexp: /^[a-z0-9\-]+$/i,
                            message: 'The occupation id can consist of alphanumeric characters.'
                        },
                        // numeric: {
                        //     message: 'The occupation id must be a number.'
                        // }
                    }
                },
                <?php
                if ($groups['id'] == 3) {
                    ...
                    license_types_id: {
                        validators: {
                            notEmpty: {
                                message: 'The license type is required.'
                            }
                        }
                    },
                    license_id: {
                        validators: {
                            notEmpty: {
                                message: 'The license id is required.'
                            },
                            stringLength: {
                                max: 20,
                                message: 'The license id must be less than 20 characters.'
                            }
                        }
                    },
                    <?php */ ?>
