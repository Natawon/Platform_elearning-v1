 ...
 */
 ...
 /**
 * @apiDefine ClientErrorTH
 * @apiError (Error 4xx) {String} message รายละเอียดข้อผิดพลาด
 */

 /** @apiDefine ClientFullErrorTH
 * @apiError (Error 4xx) {Boolean} isSuccess <code>TRUE</code> = การตรวจสอบข้อมูลผ่าน<br><code>FALSE</code> = การตรวจสอบข้อมูลไม่ผ่าน
 * @apiError (Error 4xx) {Boolean} trusted <code>TRUE</code> = ข้อมูลน่าเชื่อถือ<br><code>FALSE</code> = ข้อมูลไม่น่าเชื่อถือ
 * @apiError (Error 4xx) {DateTime} expired วันและเวลาหมดอายุของข้อมูล
 * @apiError (Error 4xx) {String} message รายละเอียดข้อผิดพลาด
 * @apiError (Error 4xx) {Object} data ข้อมูลที่ส่งมา (Plain Data)
 * @apiError (Error 4xx) {Object} invalid_params รายละเอียดข้อผิดพลาดตามฟิล์ด
 */
